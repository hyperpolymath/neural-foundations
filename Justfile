...
# Justfile for neural-foundations
...
doctor:
    @echo "Running diagnostics for neural-foundations..."
...
help-me:
    @echo "=== neural-foundations Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/neural-foundations/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: neural-foundations"
