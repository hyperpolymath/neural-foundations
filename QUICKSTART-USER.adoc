...
// Replace neural-foundations, Neural Foundations — See README.adoc for details., just run, Neural Foundations started successfully. with actuals
= neural-foundations — Quick Start for Users
:toc:
:toclevels: 2

== What is neural-foundations?

Neural Foundations — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./neural-foundations-portable
----
...
[source]
----
Neural Foundations started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/neural-foundations/wiki
